...
import { recordStore, getWrongQuestionIds } from '@/lib/quiz-store';
import { getCurrentUser as getStoredUser } from '@/components/AuthModal';
import { useApp } from '@/components/providers/AppProviders';
import { calculateStats } from '@/lib/quiz-store';
    ...
    <main className="max-w-[970px] mx-auto px-4 py-6">
      <div className="space-y-4">
        ...
        <div className="bg-white rounded-2xl p-4 shadow-sm">
          ...
          <Link href="/library">
            <Button className="w-full h-12 rounded-xl bg-gradient-to-r from-indigo-500 to-purple-500 hover:from-indigo-600 hover:to-purple-600 text-white font-semibold">
