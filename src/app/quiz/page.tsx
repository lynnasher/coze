      ...
      <div className="min-h-screen bg-slate-50">
        ...
        <div className="bg-white border-b border-slate-100 px-4 py-2">
          <div className="max-w-3xl mx-auto">
            <div className="h-2 rounded-full bg-slate-100 animate-pulse"></div>
          </div>
        </div>
        ...
        <div className="max-w-3xl mx-auto p-4 space-y-4">
          ...
          <div className="flex items-center gap-2">
            <div className="w-16 h-6 rounded-full bg-slate-200 animate-pulse"></div>
            <div className="w-12 h-4 rounded bg-slate-200 animate-pulse"></div>
          </div>
          
          {/* 题目内容骨架 */}
          <div className="bg-white rounded-2xl p-5 space-y-3 shadow-sm">
            <div className="w-full h-5 rounded bg-slate-100 animate-pulse"></div>
            <div className="w-4/5 h-5 rounded bg-slate-100 animate-pulse"></div>
            <div className="w-3/5 h-5 rounded bg-slate-100 animate-pulse"></div>
            
            {/* 选项骨架 */}
            <div className="space-y-2 pt-4">
              {[1, 2, 3, 4].map(i => (
                <div key={i} className="flex items-center gap-3">
                  <div className="w-6 h-6 rounded-lg bg-slate-100 animate-pulse"></div>
                  <div className={`h-4 rounded bg-slate-100 animate-pulse ${i % 2 === 0 ? 'w-2/3' : 'w-4/5'}`}></div>
                </div>
              ))}
            </div>
          </div>
        ...
        <div className="fixed bottom-0 left-0 right-0 bg-white border-t border-slate-200 px-4 py-3">
          <div className="max-w-3xl mx-auto flex gap-3">
            <div className="flex-1 h-11 rounded-xl bg-slate-200 animate-pulse"></div>
            <div className="flex-1 h-11 rounded-xl bg-indigo-100 animate-pulse"></div>
          </div>
        </div>
      </div>
    );
